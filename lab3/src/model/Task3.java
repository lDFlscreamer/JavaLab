...
public class Task3 {
  ...
  private  final Random random = new Random();
    ...
    public ArrayList<Patient>   searchDiagnosis(){
    ...
    if(empty) {
        System.out.println("Patient with this diagnosis dont exist");
    }

    return result;
  }

    public ArrayList<Patient >searchMedCard(){
        ArrayList<Patient> result=new ArrayList<Patient>();
      int begin,end;
      boolean empty=true;
      ...
      if(empty) {
          System.out.println("Patient in this range dont exist");
      }
    return result;
  }
